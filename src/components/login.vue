  ...
  <div class="login-wrap">
    <el-form class="login-container">
      ...
      <el-form-item label="账号">
        <el-input type="text" v-model="loginForm.username" placeholder="登录账号" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="登录密码">
        <el-input type="password" v-model="loginForm.password" placeholder="登录密码" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    login () {
      ...
      if (this.loginForm.username === '' || this.loginForm.password === '') {
        ...
        this.axios({
          ...
          let loginUser = res.data[0];
          //console.log(login_user != undefined)
          if(loginUser != undefined){
            _this.sessionStore.commit('setLoginUser',loginUser)
